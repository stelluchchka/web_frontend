...
const BurgerIcon: React.FC<IconProps> = ({ className, width, height, onClick }) => {
    ...
    return <Icon viewBox="0 0 24 24" onClick={onClick} width={width ? width : 24} height={height ? height : 24} className={classes}>
        <path d="M4 18L20 18" stroke='#3D348B' strokeWidth="2" strokeLinecap="round" />
        <path d="M4 12L20 12" stroke='#3D348B' strokeWidth="2" strokeLinecap="round" />
        <path d="M4 6L20 6" stroke='#3D348B' strokeWidth="2" strokeLinecap="round" />
    </Icon>
}
