...
const BlackApplicationIcon: React.FC = () => {
    return <svg style={{cursor: "pointer"}} fill="black" width="30px" height="30px" viewBox="0 0 16 16" id="register-16px" xmlns="http://www.w3.org/2000/svg">
...
export default BlackApplicationIcon;